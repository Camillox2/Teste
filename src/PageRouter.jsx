...
function PageFrame({ children }) {
  return <><a className="skip-link" href="#conteudo">Ir para o conteúdo</a><header className="site-header"><div className="container header-inner"><BrandLogo /><nav className="detail-nav" aria-label="Navegação principal"><a href="/#produtos">Equipamentos</a><a href="/comprar-ou-alugar">Comprar ou alugar</a></nav><a className="header-cta" href="/#contato">Falar com a YR <span aria-hidden="true">→</span></a></div></header>
